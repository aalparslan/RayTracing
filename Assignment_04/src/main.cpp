...
// locations
int locTextureHeight, locTextureWidth, locTexture, locMVP, locHeightFactor, locCameraPosition, locLightPosition, locTextureOffset, locHeightMap;
...
void initGeometry(float &heightFactor, float &aspectRatio, float &nearPlane, float &farPlane,  float &YfieldOfView){
    ...
    initialCamera.gaze = glm::vec3(0.0, 0.0, 1.0);
...
void initializeUniforms( float &heightFactor){
    ...
    locHeightMap = glGetUniformLocation(idProgramShader, "heightMapTexture");
...
int main(int argc, char *argv[]) {
    ...
    while(!glfwWindowShouldClose(win)) {
        ...
        glUniform1i(glGetUniformLocation(idProgramShader, "idHeightTexture"), 0);
