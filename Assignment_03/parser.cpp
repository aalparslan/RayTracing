...
void parser::Scene::loadFromXml(const std::string& filepath)
{
    ...
    while (element)
    {
        ...
        // This line is added for nullptr checking... Control it later@
        ...
        while (!(stream >> face.v0_id).eof())
        {
            ...
            /////// Compute Normals while setting vertex values
            Vec3f BtoA =  MatOp::vectorDifference(vertex_data[face.v0_id-1], vertex_data[face.v1_id-1]);
            Vec3f CtoA =  MatOp::vectorDifference(vertex_data[face.v0_id-1], vertex_data[face.v2_id-1]);
            face.normal = MatOp::vectorCrossProduct(BtoA, CtoA);
            face.normal =  MatOp::vectorNormalize(face.normal);
            //////////
