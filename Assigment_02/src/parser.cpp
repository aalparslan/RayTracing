...
//            texture.getImage(); // Hopefully will load the image.
...
//            std::cout<<std::endl;
//            std::cout << "ua -> "<<face.ua.x<<" , " << face.ua.y<<std::endl;
//            std::cout << "ub -> "<<face.ub.x<<" , " << face.ub.y<<std::endl;
//            std::cout << "uc -> "<<face.uc.x<<" , " << face.uc.y<<std::endl;
...
//            std::cout<<std::endl;
    ...
    while (element)
    {
        ...
        if(tex_coord_data.size() > 0 ){
            ...
            triangle.indices.ua ={0,0};
            triangle.indices.ub = {0,0};
            triangle.indices.uc = {0,0};
        }

        
//        std::cout<<std::endl;
//        std::cout << "ua -> "<< triangle.indices.ua.x<<" , " <<  triangle.indices.ua.y<<std::endl;
//        std::cout << "ub -> "<< triangle.indices.ub.x<<" , " <<  triangle.indices.ub.y<<std::endl;
//        std::cout << "uc -> "<< triangle.indices.uc.x<<" , " <<  triangle.indices.uc.y<<std::endl;
//        std::cout<< triangle.indices.v2_id<<std::endl;
//        std::cout<<std::endl;
