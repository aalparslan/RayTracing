...
public:
    ...
    parser::Vec3f CalculateTCC(int textureid,IntersectionCalculator::IntersectionData intersection, parser::Vec3f kd,
...
//    parser::Vec3f computeDiffuse(int materialID, parser::Vec3f normal, parser::Vec3f normalizedLightDirection, parser::Vec3f irradiance);
    parser::Vec3f computeDiffuse( parser::Vec3f texelConstant, parser::Vec3f normal,
